                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3">
                                ...
                                <div class="mil-team-card mil-up mil-mb-30">
                                    ...
                                    <div class="mil-description">
                                        <div class="mil-secrc-text">
                                            <h5 class="mil-muted mil-mb-5"><a href="home-1.php">Oscar Freeman</a></h5>
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3">
                                ...
                                <div class="mil-team-card mil-up mil-mb-30">
                                    ...
                                    <div class="mil-description">
                                        <div class="mil-secrc-text">
                                            <h5 class="mil-muted mil-mb-5"><a href="home-1.php">Tom Oldman</a></h5>
                                            <p class="mil-link mil-light-soft mil-mb-10">Art Director</p>
                                            <ul class="mil-social-icons mil-center">
                                                <li><a href="#." target="_blank" class="social-icon"> <i class="fab fa-behance"></i></a></li>
                                                <li><a href="#." target="_blank" class="social-icon"> <i class="fab fa-dribbble"></i></a></li>
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3">
                                ...
                                <div class="mil-team-card mil-up mil-mb-30">
                                    ...
                                    <div class="mil-description">
                                        <div class="mil-secrc-text">
                                            <h5 class="mil-muted mil-mb-5"><a href="home-1.php">Corey Trueman</a></h5>
                                            <p class="mil-link mil-light-soft mil-mb-10">Art Director</p>
                                            <ul class="mil-social-icons mil-center">
                                                <li><a href="#." target="_blank" class="social-icon"> <i class="fab fa-behance"></i></a></li>
                                                <li><a href="#." target="_blank" class="social-icon"> <i class="fab fa-dribbble"></i></a></li>
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3">
                                ...
                                <div class="mil-team-card mil-up mil-mb-30">
                                    ...
                                    <div class="mil-description">
                                        <div class="mil-secrc-text">
                                            <h5 class="mil-muted mil-mb-5"><a href="home-1.php">Justin Newman</a></h5>
                                            <p class="mil-link mil-light-soft mil-mb-10">Art Director</p>
                                            <ul class="mil-social-icons mil-center">
                                                <li><a href="#." target="_blank" class="social-icon"> <i class="fab fa-behance"></i></a></li>
                                                <li><a href="#." target="_blank" class="social-icon"> <i class="fab fa-dribbble"></i></a></li>
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3">
                                ...
                                <div class="mil-team-card mil-up mil-mb-30">
                                    ...
                                    <div class="mil-description">
                                        <div class="mil-secrc-text">
                                            <h5 class="mil-muted mil-mb-5"><a href="home-1.php">Spunkie</a></h5>
