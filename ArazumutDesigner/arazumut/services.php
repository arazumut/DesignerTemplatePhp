                                    ...
                                    <div class="col-lg-7">
                                        <div class="row">
                                            <div class="col-md-6 col-lg-6">
                                                <a href="service.php" class="mil-service-card-lg mil-more mil-accent-cursor mil-offset">
                                            ...
                                            <div class="col-md-6 col-lg-6">
                                                <a href="service.php" class="mil-service-card-lg mil-more mil-accent-cursor">
