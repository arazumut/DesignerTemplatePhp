    ...
    <div class="mil-wrapper" id="top">
        ...
        <div class="mil-preloader">
            <div class="mil-preloader-animation">
                <div class="mil-pos-abs mil-animation-1">
                    <p class="mil-h3 mil-muted mil-thin">Umut</p>
                    <p class="mil-h3 mil-muted">Araz</p>
                    <p class="mil-h3 mil-muted mil-thin">Designer</p>
                </div>
                <div class="mil-pos-abs mil-animation-2">
                    <div class="mil-reveal-frame">
                        <p class="mil-reveal-box"></p>
                        <p class="mil-h3 mil-muted mil-thin">UmutAraz.com</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="mil-menu-frame">
            ...
            <div class="mil-frame-top">
                <a href="home-1.php" class="mil-logo">U.</a>
                                ...
                                <ul>
                                    <li class="mil-has-children">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="home-1.php">Personal</a></li>
                                            <li><a href="portfolio-1.php">Portfolio slider</a></li>
                                        </ul>
                                    </li>
                                    <li class="mil-has-children mil-active">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="portfolio-1.php">Grid type 2</a></li>
                                            <li><a href="portfolio-1.php">Slider</a></li>
                                        </ul>
                                    </li>
                                    <li class="mil-has-children">
                                        <a href="#.">Services</a>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-8 mil-mb-60">
                                            ...
                                            <ul class="mil-menu-list">
                                                ...
                                                <li><a href="project-1.php" class="mil-light-soft">Home Security Camera</a></li>
                                            </ul>
                    ...
                    <div class="container mil-portfolio mil-p-120-60">
                        ...
                        <div class="row justify-content-between align-items-center">
                            <div class="col-lg-5">
                                ...
                                <a href="project-1.php" class="mil-portfolio-item mil-more mil-mb-60">
                            ...
                            <div class="col-lg-6">
                                ...
                                <a href="project-1.php" class="mil-portfolio-item mil-more mil-parallax mil-mb-60" data-value-1="60" data-value-2="-60">
